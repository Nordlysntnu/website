...
const teamGroups = ['Board', 'Electrical', 'Mechanical','Strategy', 'Marketing', 'Logistics', 'Technical advisor','Alumni', 'All active members'];
...
const groupDescriptions = {
    ...
    'Marketing': <p><b>The Marketing group</b> is responsible for the social media, merch, graphical profile and sponsor relations for Nordlys NTNU</p>,
