...
description:
The mechanical group designs and builds all the dynamic mechanical systems of the solar car. Systems include braking, suspension and steering.
...
description:
The winning team needs a winning driving strategy. The software group develops software analysis tools to calculate the solar cars optimal speed.
